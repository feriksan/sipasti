...
@section('isi')
    ...
    <div id="content" class="app-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-1">
            ...
            <div class="ms-auto">
                <a href="disposisiOp/data" onclick="baru();return false;" id="new_rm" name="new_rm" class="btn btn-primary btn-sm"><i class="fa fa-search mr-1"></i> Data Disposisi</a>

                <a href="/home/operator" class="btn btn-danger btn-sm"><i class="fa fa-minus mr-1"></i> Tutup Halaman</a>
            </div>
        </div>
        <!--end breadcrumb-->
