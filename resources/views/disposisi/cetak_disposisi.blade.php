    ...
    <table class="table table-borderless table-panel mb-0">
        <tbody>
            <tr>
                ...
                <td class="col-6">
                    <h6>{{ $direktur->jabatan }},</h6>
                    <img src="{{ asset('uploads') }}/qrcode_tte/{{ $direktur->qrcode_tte }}" class="img border-0" height="50px" width="60px">
                    <br>
                    <h6><b>{{ $direktur->nama_pejabat }}</b></h6>
                    <h6><b>{{ $direktur->nip }}</b></h6>
                </td>
            </tr>
        </tbody>
    </table>
