...
<div id="content" class="app-content">
    <div class="page-content">
        ...
        <form action="/disposisiOp/data" method="GET">
            <?= csrf_field(); ?>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <a href="/monitoring-disposisiOp" class="btn btn-sm btn-danger"><i class="fa fa-minus mr-1"></i> Tutup Halaman</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive mt-1">
                        <table id="TabelData1" class="table table-bordered table-sm">
                            ...
                            <tbody>
                                @php $no = 1; @endphp
                                @foreach($data_disposisiOp as $baris)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/surma/buka3/{{ $baris->no_agenda}}" target="_blank"  class="btn btn-xs btn-primary"><i class="fa fa-folder-open mr-1"></i></a>
                                    </td>
                                    <td class="text-center">
                                        @if ($baris->status_pejabat == "Belum")
                                            <a href="/disposisiOp/cetak/{{$baris->no_agenda}}" target="_blank" class="btn btn-yellow btn-xs disabled"><i class="fa fa-print mg-r-10"></i> Cetak</a>
                                        @elseif ($baris->status_pejabat == "Selesai")
                                            <a href="/disposisiOp/cetak/{{$baris->no_agenda}}" target="_blank" class="btn btn-yellow btn-xs"><i class="fa fa-print mg-r-10"></i></a>
                                        @endif
                                    </td>                          
                                </tr>
                                @endforeach
