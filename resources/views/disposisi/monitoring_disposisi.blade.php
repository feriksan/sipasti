    ...
    <div id="content" class="app-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-1">
            <div class="breadcrumb mb-0">
                <h4><?= $judul_halaman ?> - Sekretariat | Tanggal : <?php echo date('d-m-Y') ?></h4>
            </div>
            <div class="ms-auto">
                <a href="disposisi/data" onclick="baru();return false;" id="new_rm" name="new_rm" class="btn btn-primary btn-sm"><i class="fa fa-search mr-1"></i> Data Disposisi</a>
