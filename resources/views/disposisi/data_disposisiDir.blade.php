...
<div id="content" class="app-content">
    <div class="page-content">
        ...
        <form action="/disposisiDir/data" method="GET">
            <?= csrf_field(); ?>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <a href="/monitoring-disposisiDir" class="btn btn-sm btn-danger"><i class="fa fa-minus mr-1"></i> Tutup Halaman</a>
                        </div>
                    </div>
                </div>
            </div>
