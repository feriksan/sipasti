...
class AsetLainController extends Controller
{
    ...
    {
        $this->AlatLainModel = new AlatLainModel();
    }

    public function index()
    {
        $AsetLainModel = new AlatLainModel();
        $pejabat = $AsetLainModel->pejabat();
        $kode_otomatis =$AsetLainModel->kode_otomatis();
